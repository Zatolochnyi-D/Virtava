...
class ArkitBlendshapesResult(_message.Message):
    __slots__ = ("trackingSucceded", "timestamp", "blendshapes")
    ...
    def __init__(self, trackingSucceded: bool = ..., timestamp: _Optional[int] = ..., blendshapes: _Optional[_Union[Blendshapes, _Mapping]] = ...) -> None: ...
